...
- Cluster Issuer 상태 확인
  ...
  <img src="images/17_cluster_issuer.png" title="100px" alt="cluster_issuer"> <br>
  
- ca-issuer를 선택하여 아래 상태 확인 시 *Sigining CA verified*라고 보여야 합니다.
  
  <img src="images/18_ca_issuer_ready.png" title="100px" alt="ca_issuer_ready"> <br>  
...
- GitLab Web Service Default 
  <img src="images/21_gitlab_route2.png" title="100px" alt="gitlab_route2"> <br>  
